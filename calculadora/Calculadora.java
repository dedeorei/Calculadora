 ...
 * <p>Esse projeto foi utilizado para demonstrar:</p>
 * <ul>
 ...
 *
 * @author André Ferreira Gonçalves
 * @version 1.0
 */
package calculadora;
...
public class Calculadora {
     ...
     *
     * <p>Caso o divisor seja zero, uma exceção será lançada, pois a operação
     * de divisão por zero não é permitida.</p>
     *
     * @param a dividendo
     * @param b divisor
